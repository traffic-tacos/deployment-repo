...
│   └──k6/                                 # 성능 테스트
│       ├──k6-job/
│       │   └── k6-job-configmap.yaml      # RPS 테스트 시나리오
│       │   └── k6-job.yaml                # k6 job (k6 operator 사용 안하는 버전)
│       └── k6-operator
│       │   └── TestRun.yaml               # k6 operator CRD TestRun
│       │   └── aws-sigv4-proxy.yaml       # TestRun 생성 Pod에 injection할 AWS 인증 Proxy용 Container
│       │   └── k6-configmap.yaml          # RPS 테스트 시나리오
│       └── values.yaml                    # K6 Operator Helm Chart values.yaml
│
...
├── references/                             # 참고 자료
│   ├── docs/
│   └── k6-load-tests/                      # K6 부하 테스트 Cleanup 예시
│
...
- **Phase 1**: Warm-up   (0분)
- **Phase 2**: Ramp-up   (0분)
- **Phase 3**: Peak Load (5분, 0->30k RPS)
- **Phase 4**: Cool Down (5분, 30k->0 RPS)

### 성능 테스트 결과

 █ THRESHOLDS
    http_req_duration
    ✓ 'p(95)<5000' p(95)=480.02ms
    ✓ 'p(99)<7000' p(99)=2.88s
    http_req_failed
    ✓ 'rate<0.1' rate=0.48%
    queue_enter_fail
    ✓ 'rate<0.2' rate=16.13%
  ...
  █ TOTAL RESULTS
    checks_total.......: 106148 344.082632/s
    checks_succeeded...: 92.98% 98700 out of 106148
    checks_failed......: 7.01%  7448 out of 106148
    CUSTOM
    api_count......................: 30000  97.246099/s
    api_success....................: 19351  62.726976/s
    queue_enter_fail...............: 16.13% 3723 out of 23074
    queue_join_fail................: 0.00%  1 out of 30000
    queue_status_fail..............: 0.00%  0 out of 0
    HTTP
    http_req_duration..............: avg=104.15ms min=5.4ms  med=11ms  max=1m0s  p(90)=28.59ms p(95)=480.02ms
      { expected_response:true }...: avg=104.46ms min=5.68ms med=11ms  max=9.29s p(90)=27.31ms p(95)=484.01ms
    http_req_failed................: 0.48%  3724 out of 760431
    http_reqs......................: 760431 2464.964953/s
    EXECUTION
    iteration_duration.............: avg=16.06s   min=7s     med=16.1s max=1m3s  p(90)=19.32s  p(95)=20.4s
    iterations.....................: 23075  74.798458/s
    vus............................: 766    min=0              max=29602
    vus_max........................: 30000  min=5698           max=30000
    NETWORK
    data_received..................: 607 MB 2.0 MB/s
    data_sent......................: 62 MB  202 kB/s
